...
function carregarDados() {
    firebase.database().ref('estoqueBarrasg32').once('value').then(function(snapshot) {
    ...
    firebase.database().ref('pecasRequeridasg32').once('value').then(function(snapshot) {
...
function salvarDados() {
    firebase.database().ref('estoqueBarrasg32').set(estoqueBarras);
    firebase.database().ref('pecasRequeridasg32').set(pecasRequeridas);
}
...
function gerarRelatorioPDF() {
    ...
    doc.setFontSize(16);
    doc.text("OTIMIZAÇÃO DE BARRAS Ø32 - GERDAU", 50, y);
    y += 10;
    doc.setFontSize(12);
...
function gerarListaEstoquePDF() {
    ...
    doc.setFontSize(16);
    doc.text("LISTA DE ESTOQUE GERDAU Ø32", 10, y);
    y += 10;
